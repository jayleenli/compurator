...
const LoginPage: React.FC<RouteComponentProps> = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login | Compurator</title>
      </Helmet>
      <BodyStyles />
      <Layout>
        <Card>
          <Profile>
            <Flipped flipId="richert" spring="veryGentle">
              <ProfileImage src={richert} />
            </Flipped>
            <ProfileTitle>
              <MainTitle>Let's compare products!</MainTitle>
